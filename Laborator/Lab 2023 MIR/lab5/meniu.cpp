    ...
    while (op) {
        ...
        else if (optiune == 3)
        {
            ...
            if (index == -1) {
                ...
                std::cout << "Entitatea cu cea mai mare arie este: " << maxEntitate << "si are aria "<<maxEntitate.arie()<<'\n';
            }
        }
        ...
        else if (optiune == 4)
        {
            ...
            std::cout << "Numarul de entiati din cadranul 1: " << count <<'\n';
        }
        ...
        else if (optiune == 51)
        {
            Entitate e;
            int start, stop;
            int maxLength = rep.getLongestEqualSequence(start,stop);
            if (maxLength > 1) {
        ...
        else if (optiune == 10000)
        {
            meniuAdd(rep);
            meniuPrint(rep);
            std::cout<<countTrianglesInQuadrant1231(rep);
            std::cout<<getLongestEqualSequencee(rep);
            std::cout<<getIndexOfMaxEntitate1(rep);
