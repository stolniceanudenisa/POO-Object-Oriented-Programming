...
console::console(){
    ...
    functi.push_back(&console::exportReteta); //11
    functi.push_back(&console::adaugaInReteta); //12
    functi.push_back(&console::golesteReteta);
    functi.push_back(&console::genereazaReteta);
...
void console::run(){
    ...
    while(true){
        ...
        cout << "13. Goleste reteta .   \n";
        cout << "14. Genereaza reteta .   \n";
        cout<<"15. Iesi din aplicatie.   \n";
        cout<<'\n';
